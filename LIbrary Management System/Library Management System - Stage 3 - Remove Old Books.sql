...
-- Eric Rampy returned the book ten days before the return date. Make the necessary changes 
-- to the operation table: change the return date and the returned column to true for transaction;
